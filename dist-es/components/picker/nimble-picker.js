...
function (_React$PureComponent) {
  ...
  function NimblePicker(props) {
    ...
    _this.setAnchorsRef = _this.setAnchorsRef.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleAnchorClick = _this.handleAnchorClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.setSearchRef = _this.setSearchRef.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleSearch = _this.handleSearch.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.setScrollRef = _this.setScrollRef.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleScroll = _this.handleScroll.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleScrollPaint = _this.handleScrollPaint.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleEmojiOver = _this.handleEmojiOver.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleEmojiLeave = _this.handleEmojiLeave.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleEmojiClick = _this.handleEmojiClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleEmojiSelect = _this.handleEmojiSelect.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.setPreviewRef = _this.setPreviewRef.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handleSkinChange = _this.handleSkinChange.bind(_assertThisInitialized(_assertThisInitialized(_this)));
